...
// CODE HERE
const sayHelloButtonRevert = () => {
    sayHelloButton.style.backgroundColor = '#EFEFEF';
    sayHelloButton.style.color = 'black'
}

sayHelloButton.addEventListener('mouseout',sayHelloButtonRevert)
...
const repeatMyParam = () => {
    //YOUR CODE HERE
    axios.get(`http://localhost:3000/repeat/abcdefghi`).then(res => {
...
// CODE HERE
const sendAQuery = () => {
    axios.get('http://localhost:3000/query-test/?asdfa=345&&ieieie=789').then(res => {
        console.log(res.data)
    }).catch(err => {
        console.log(err)
    })
